...
> 从 5 个 200-700 行的"巨石 SKILL.md"重构为模块化架构，全面升级。

### 主要变化
- ✅ **拆分 SKILL.md + references/**：单文件 541-700 行 → 主文件 200-300 行 + references
...
**v1.1 重大变更**：从"三步投资法"升级为"四步投资法"，**完整覆盖 5 个 Skill（原版只覆盖 3 个）**。
